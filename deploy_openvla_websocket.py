...
class DeployConfig:
    # fmt: off
    openvla_path: Union[str, Path] = "openvla-7b+real_ur10e+b2+lr-0.0005+lora-r32+dropout-0.0"    #"tritran1719/generalist" "openvla/openvla-7b"      # HF Hub Path (or path to local run directory)
